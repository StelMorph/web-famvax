...
function HelpCenterScreen() {
  ...
  const faqs = [
    {
      ...
      answer:
        'Go to the "My Family" tab and tap the "+ Add Member" button. From there, you can either scan a document with AI (Premium feature) or enter the details manually.',
    },
    {
      question: 'How does profile sharing work?',
      answer:
        "Navigate to a profile you own, tap the share icon, enter the recipient's email, and choose a role. Sharing requires a premium subscription.",
    },
    {
      question: 'Is my data secure?',
      answer:
        'Yes. All data is encrypted both in transit and at rest in our secure cloud database. We never sell your personal health information.',
    },
  ];
  ...
  const handleAskAI = (e) => {
    ...
    showNotification({
      type: 'info',
      title: 'AI Assistant',
      message: `Asking AI: "${searchTerm}" (This is a placeholder).`,
    });
    setSearchTerm('');
  };
