...
// FIX: Read configuration from the central .env file
  ...
  return (
    <div className="modal-content" style={{ maxWidth: '480px', textAlign: 'center' }}>
      <div className="modal-header" style={{ justifyContent: 'center', borderBottom: 'none' }}>
        <div
          className="main-ai-icon"
          style={{ backgroundColor: '#e7f3ff', color: 'var(--primary-color)' }}
        >
      ...
      <div className="modal-body" style={{ minHeight: 'auto' }}>
        ...
        <p>
          We've sent a 6-digit code to <strong>{email}</strong>. Please enter it below to confirm
          your account.
        </p>
      ...
      <div
        ...
        style={{ justifyContent: 'center', borderTop: 'none', paddingTop: 0 }}
      >
