      ...
      <div className="modal-body-scrollable">
        <form onSubmit={handleSubmit} id="edit-profile-form">
          ...
          <div className="form-group">
            ...
            <select name="relationship" value={formData.relationship} onChange={handleSimpleChange}>
              <option>Self</option>
              <option>Child</option>
          ...
          <div className="form-group">
            <label>Gender</label>
            <select name="gender" value={formData.gender} onChange={handleSimpleChange}>
              <option>Male</option>
          ...
          <div className="form-group">
            ...
            <select name="bloodType" value={formData.bloodType} onChange={handleSimpleChange}>
              <option>O+</option>
              <option>O-</option>
              <option>A+</option>
              <option>A-</option>
